...
from gp.utils.admin.city import TabularClientCities
from gp.utils.admin.photo import TabularClientPhotos
from gp.utils.admin.video import TabularClientVideos
...
class ClientAdmin(admin.ModelAdmin):
    ...
    list_display = ('first_name', 'last_name', 'slug',  'age', 'cacheForHours',
                    'genre', 'ethnicity')
    list_filter = ('genre', 'ethnicity')
    exclude = ()
